...
//                        break;
                    ...
                    case "checkDuplicate":
                        ...
                        break;
					case "checkDuplicateconame":
                        errorMsg = methods._checkDuplicateconame(field, rules, i, options);
                        break;
					case "checkDuplicatephone":
                        errorMsg = methods._checkDuplicatephone(field, rules, i, options);
                        break;
                    case "funcCall":
		...
		_checkDuplicateconame: function(field, rules, i, options) {
            var equalsField = rules[i + 1];
            if (field.attr('value') == $("#" + equalsField).attr('value'))
                return options.allrules.checkDuplicateconame.alertText;
        },
		_checkDuplicatephone: function(field, rules, i, options) {
            var equalsField = rules[i + 1];
            if (field.attr('value') == $("#" + equalsField).attr('value'))
                return options.allrules.checkDuplicatephone.alertText;
        },
        /**
